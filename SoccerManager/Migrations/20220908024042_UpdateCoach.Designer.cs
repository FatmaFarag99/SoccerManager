...
namespace SoccerManager.Migrations
{
    ...
    [Migration("20220908024042_UpdateCoach")]
            ...
            modelBuilder.Entity("Coaches.Server.Coach", b =>
                {
                    ...
                    b.HasCheckConstraint("ck_NationalTeamIdOrLeagueTeamId", "(NationalTeamId is not null and LeagueTeamId is null) or (LeagueTeamId is not null and NationalTeamId is null)");
                });
